...
def add_album(albums)
  ...
  puts "Select genre:\n1. Pop\n2. Classic\n3. Jazz\n4. Rock"
  genre_choice = read_integer_in_range("Enter number of genre: ", 1, 4)
  genre = genre_choice.to_s 
  track_count = read_integer("Enter number of tracks: ")
  tracks = []

  i = 0
  while i < track_count
    puts "Enter details for track #{i + 1}:"
    name = read_string("Enter name for the new track: ")
    location = read_string("Enter location for the new track: ")
