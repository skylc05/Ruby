...
def main()
	...
	appetizer_price = gets.chomp.to_f() # this is a bit complicated - ask your tutor to explain each part
	...
	print("$")
	printf("%.2f", total_price.to_s) # format the float to 2 decimal places
